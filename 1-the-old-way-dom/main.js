...
const product1 = { name: 'Product 1', description: 'This is a product description.', price: 9.99 };
const product2 = { name: 'Product 2', description: 'This is a product description.', price: 19.99 };
const product3 = { name: 'Product 3', description: 'This is a product description.', price: 29.99 };
